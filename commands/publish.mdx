...
one-command release pipeline, `asc release run` remains available as a
deprecated compatibility path.

Prefer migrating day-to-day App Store shipping to `asc publish appstore` and
using `asc release stage` for pre-submit preparation work.
