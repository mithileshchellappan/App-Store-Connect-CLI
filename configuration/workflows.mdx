...
```json  theme={null}
{
  ...
  "workflows": {
    ...
    "release": {
      ...
      "steps": [
        "asc release run --app $APP_ID --version $VERSION --build $BUILD_ID --metadata-dir ./metadata/version/$VERSION --confirm"
      ]
    }
  }
}
    ...
    "release": {
      ...
      "steps": [
        ...
        "asc release run --app $APP_ID --version $VERSION --build $BUILD_ID --metadata-dir ./metadata/version/$VERSION --confirm",
        {
          "workflow": "notify",
          "with": {
            "MESSAGE": "Published App Store release pipeline started"
          }
        }
      ]
    }
    ...
    "release": {
      ...
      "steps": [
        ...
        },
        {
          ...
          "workflow": "notify",
          "with": {
            "MESSAGE": "v$VERSION release pipeline submitted to App Store review"
          }
        }
      ]
    },
